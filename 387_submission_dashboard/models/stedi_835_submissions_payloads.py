...
def _fetch_existing_transaction_ids(context: ExecutionContext) -> set[str]:
    query = """
        ...
        FROM raw.stedi_835_submissions_payloads
...
@model(
    "raw.stedi_835_submissions_payloads",
    kind={
    ...
    depends_on=["raw.stedi_835_submissions"],
)
def execute(
    ...
    **kwargs: t.Any,
    ...
    upstream_table = context.resolve_table("raw.stedi_835_submissions")
